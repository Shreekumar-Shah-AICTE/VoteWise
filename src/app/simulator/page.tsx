    ...
    <main id="main-content" className="min-h-screen">
        ...
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-semibold">
              <span aria-hidden="true">🗳️</span> Mock Voting Simulator
            </h1>
            <p className="text-xs text-gray-500">
              Experience the EVM voting process
            </p>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        {phase === "intro" && (
          <div className="text-center animate-fade-in">
            ...
            <p className="text-gray-400 mb-8 max-w-md mx-auto">
              Experience the complete voting process — from ID verification to
              casting your vote on an EVM. This is a safe, educational
              simulation using fictional candidates.
            </p>
            <div className="glass-card p-4 mb-8 text-left">
              ...
              <ol className="text-sm text-gray-400 space-y-1 list-decimal list-inside">
                ...
                <li>
                  Casting your vote on the Electronic Voting Machine (EVM)
                </li>
            ...
            <button
              onClick={() => setPhase("id-check")}
              className="px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all hover:scale-105 focus-visible:ring-2 focus-visible:ring-indigo-400"
            >
          ...
          <div className="animate-fade-in">
            <div className="glass-card p-6 text-center mb-6">
              ...
              <p className="text-gray-400 text-sm mb-6">
                At the polling station, the Booth Level Officer (BLO) checks
                your identity against the electoral roll.
              </p>
              ...
              <button
                ...
                className="px-8 py-3 bg-green-600 hover:bg-green-500 text-white font-semibold rounded-xl transition-all hover:scale-105 focus-visible:ring-2 focus-visible:ring-green-400"
              >
        ...
        {phase === "voting" && (
          <div className="animate-fade-in">
            ...
            <p className="text-gray-400 text-center text-sm mb-6">
              Select your preferred candidate on the EVM below
            </p>

            {/* EVM Simulation */}
            <div
              className="glass-card p-1 rounded-2xl border-2 border-gray-700 bg-gray-900"
              role="group"
            ...
            >
              ...
              <div className="bg-gray-800 rounded-t-xl p-3 text-center border-b border-gray-700">
                <p className="text-xs text-gray-400 font-mono">
                  BALLOT UNIT — ELECTRONIC VOTING MACHINE
                </p>
                <p className="text-xs text-gray-500 font-mono">
                  Constituency: Demo Constituency (Educational Simulation)
                </p>
              </div>
              ...
              <div className="divide-y divide-gray-800">
                {mockCandidates.map((candidate) => (
                  ...
                  >
                    ...
                    {/* Party symbol */}
                    <span
                      className="text-xl w-10 text-center"
        ...
        {phase === "vvpat" && votedCandidate && (
          <div className="text-center animate-fade-in">
            <h2 className="text-xl font-bold mb-2">
              Step 3: VVPAT Verification
            </h2>
            <p className="text-gray-400 text-sm mb-6">
              The VVPAT machine displays your vote for 7 seconds
            </p>
            <div className="glass-card p-6 max-w-xs mx-auto border-2 border-yellow-500/30 bg-yellow-500/5">
              ...
              <div className="border-2 border-dashed border-gray-600 p-4 rounded-lg bg-white/5">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  S.No: {votedCandidate.serialNumber}
                </p>
              </div>
              <p className="text-xs text-yellow-400 mt-3 animate-pulse">
                Displaying for 7 seconds...
              </p>
            </div>
          </div>
        )}
        ...
        {phase === "ink" && (
          <div className="text-center animate-fade-in">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Indelible ink is applied to your left index finger to prevent
              duplicate voting.
            </p>
            <div className="glass-card p-4 max-w-sm mx-auto text-sm text-gray-400">
              <p>
                The ink contains silver nitrate and cannot be washed off for
                several days. This ensures every citizen votes only once.
              </p>
            </div>
          </div>
        )}
        ...
        {phase === "complete" && votedCandidate && (
          <div className="text-center animate-fade-in">
            ...
            <p className="text-gray-400 mb-6">
              You&apos;ve successfully completed the mock voting simulation.
            </p>
            ...
            <p className="text-sm text-indigo-400 mb-6">
              Remember: Your real vote is secret and sacred. Every vote counts
              in our democracy! 🇮🇳
            </p>
            <div className="flex flex-col gap-3 max-w-xs mx-auto">
              <button
                onClick={reset}
                className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all hover:scale-105 focus-visible:ring-2 focus-visible:ring-indigo-400"
              >
                Try Again
              </button>
