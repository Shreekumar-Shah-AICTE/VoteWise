...
const QUESTIONS = [
  {
    id: 1,
    q: "Do you have a valid Voter ID card (EPIC)?",
    category: "registration",
  },
  {
    id: 2,
    q: "Is your name on the electoral roll for your current address?",
    category: "registration",
  },
  {
    id: 3,
    q: "Do you know the location of your polling station?",
    category: "registration",
  },
  {
    id: 4,
    q: "Do you know the 7 steps of India's election process?",
    category: "knowledge",
  },
  ...
  {
    id: 7,
    q: "Do you have a valid photo ID to carry on polling day?",
    category: "documents",
  },
  {
    id: 8,
    q: "Do you know the polling hours in your constituency?",
    category: "documents",
  },
  {
    id: 9,
    q: "Do you know your fundamental right to vote is protected by the Constitution?",
    category: "rights",
  },
  {
    id: 10,
    q: "Do you know how to report election violations using cVIGIL?",
    category: "rights",
  },
];
      ...
      <header className="border-b border-white/5 bg-gray-950/80 backdrop-blur-lg sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-lg font-semibold">
            <span aria-hidden="true">✅</span> Voter Readiness Check
          </h1>
        </div>
      </header>
          ...
          <div className="animate-fade-in">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-2">
                Are You <span className="text-indigo-400">Vote Ready</span>?
              </h2>
              <p className="text-gray-400 text-sm">
                Answer these 10 questions to check your preparedness
              </p>
            </div>
          ...
          <div className="text-center animate-fade-in">
            ...
            <div className="glass-card p-4 max-w-sm mx-auto mb-6 text-left">
              {[
                ...
                >
                  ...
                  <span
                    className={`text-sm font-semibold ${getCategory(cat.key) >= 80 ? "text-green-400" : getCategory(cat.key) >= 50 ? "text-yellow-400" : "text-red-400"}`}
                  >
                    {getCategory(cat.key)}%
                  </span>
                </div>
            ...
            {score < 80 && (
              <div className="glass-card p-4 max-w-sm mx-auto mb-6 text-left">
                ...
                <ul className="text-sm text-gray-400 space-y-1">
                  {getCategory("registration") < 100 && (
                    <li>• Complete your voter registration at nvsp.in</li>
                  )}
                  {getCategory("knowledge") < 100 && (
                    <li>• Learn the election process on our Timeline page</li>
                  )}
                  {getCategory("documents") < 100 && (
                    <li>• Prepare your photo ID and check polling station</li>
                  )}
                  {getCategory("rights") < 100 && (
                    <li>• Download the Voter Helpline and cVIGIL apps</li>
                  )}
                </ul>
              </div>
            )}
            ...
            <div className="flex flex-col gap-3 max-w-xs mx-auto">
              <button
                ...
                className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all hover:scale-105"
              >
                Retake Assessment
              </button>
